...
export type KeyActionId =
  ...
  | "view.home" | "view.library" | "view.clip" | "view.coreview" | "view.reader" | "view.multitrack"
...
export const KEY_ACTIONS: KeyAction[] = [
  ...
  // Top-level view switch (nav rail): Home = the landing page, Library = the
  // detail browser, Clip = the editor, Review = co-review. Global like the
  // other ⌘-chords — navigation must work from a text field.
  { id: "view.home",       label: "Go to Home",            group: "View",      defaults: ["mod+1"],                 global: true },
  { id: "view.library",    label: "Go to Library",         group: "View",      defaults: ["mod+2"],                 global: true },
