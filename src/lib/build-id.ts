 ...
 * src-tauri/src/commands/system.rs. Bump both sides together whenever you add or
 ...
 */
export const EXPECTED_BACKEND_BUILD_ID = "2026-09-15-multitrack-lifecycle-fixes";
