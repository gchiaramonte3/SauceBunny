...
export function MultitrackRunInfo({ document, report, error, loading }: {
  ...
  return <div className="cp-multitrack-run-info">
    ...
    <details><summary>Get Info</summary>
      <p>Results are saved with this sequence in AAF Audio → Saved sequences. They are not automatically added as separate files in Transcripts. Export below to choose a CSV or text file location.</p>
