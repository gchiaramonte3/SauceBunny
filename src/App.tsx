...
export default function App() {
  ...
  }, [exportOpts.folder, queueRunning, runLocalClipExport, appendLog, pushNotification, cookiesBrowserOrNone]);
  ...
  const handleGenerateTranscript = useCallback(async () => {
    ...
    try {
      ...
      durationFrames, inFrames, outFrames, cookiesBrowserOrNone]);
  ...
  const handleFixCaptionTiming = useCallback(async () => {
    ...
    try {
      ...
      defaults.expectedSpeakers, defaults.transcriptionLanguage, appendLog, cookiesBrowserOrNone]);
