...
export default defineConfig({
  ...
  test: {
    ...
    // Native build-script fixtures use Node's runner in their explicit gates.
    // Collecting them here would run fixtures but register zero Vitest tests.
    exclude: [...configDefaults.exclude, "e2e/**", ".claude/**", "premiere-companion/**", "scripts/prepare-ndi-bundle.test.mjs", "scripts/verify-ndi-package.test.mjs", "scripts/profile-ndi-processes.test.mjs", "scripts/inspect-obs-runtime.test.mjs", "scripts/obs-av-sync.test.mjs", "scripts/obs-discovery.test.mjs", "scripts/stable-signing.test.mjs", "scripts/capture-policy.test.mjs", "scripts/stage-obs-runtime.test.mjs", "scripts/stage-obs-app.test.mjs", "scripts/verify-obs-app.test.mjs", "scripts/snapshot-obs-source.test.mjs", "scripts/obs-source-inputs.test.mjs", "scripts/stage-obs-source.test.mjs", "scripts/obs-service-test-target.test.mjs", "scripts/ndi-sender-process.test.mjs", "scripts/ndi-sender-artifact.test.mjs", "scripts/audio-analysis.test.mjs"],
